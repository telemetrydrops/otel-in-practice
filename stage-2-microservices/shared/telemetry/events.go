...
// SetupTelemetry. The scope comes from the package-level serviceScope variable
// set in SetupTelemetry, so events emitted by this package are correlated with
// the right service.
